...
public class BurgerTest {
    ...
    @Test
    public void shouldBeAddIngredientTest() {
    ...
    @Test
    public void shouldBeRemoveIngredientTest() {
    ...
    @Test
    public void shouldBeMoveIngredientTest() {
        index = 1;
        newIndex = 2;
    ...
    @Test
    public void shouldBeGetPriceTest() {
        burger.setBuns(bun);
        Mockito.when(bun.getPrice()).thenReturn(20F);
        float actual = burger.getPrice();
        float expected = 1240F;
        assertEquals(expected, actual, dif);
    }

    @Test
    public void shouldBeGetReceiptTest() {
        burger.setBuns(bun);
